                ...
                <img src="{{ asset('base-hotel/preview/images/contacto2.jpg') }}" width="1200" height="400" alt="" />
                    ...
                    <div class="col">
                        ...
                        @if (Auth::user())
                            ...
                            <div class="field mandatory"><input name="contact-name" type="text" placeholder="Your Name" id="contact-name" value="{{ Auth::user()->name }}" /></div>
                            <div class="field mandatory"><input name="contact-email" type="email" placeholder="Email Address" id="contact-email" value="{{ Auth::user()->email }}" /></div>
                            <div class="field mandatory"><input name="contact-phone" type="number" placeholder="Phone Number" id="contact-phone" value="{{ Auth::user()->str_telefono }}" /></div>
