                ...
                <img src="{{ asset('base-hotel/preview/images/contacto2.jpg') }}" width="1200" height="400" alt="" />
                    ...
                    <div class="col">
                        ...
                        @if (Auth::user())
                            ...
                            <div class="field mandatory"><input name="contact-phone" type="number" placeholder="Phone Number" id="contact-phone" value="{{ Auth::user()->str_telefono }}" required/></div>
                        ...
                        @else
                            ...
                            <div class="field mandatory"><input name="contact-phone" type="number" placeholder="Phone Number" id="contact-phone" value="" required/></div>
